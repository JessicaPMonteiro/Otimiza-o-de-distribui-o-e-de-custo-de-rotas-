...
media_produtividade = Tabela_nova['Produtividade'].mean()

# Calculando a mediana da coluna 'Produtividade'
mediana_produtividade = Tabela_nova['Produtividade'].median()
...
for mes in range(1, 12):
    ...
    df_filtrado = Tabela_nova[Tabela_nova['Mes.Base'] == mes]
...
df = pd.read_csv('/content/drive/My Drive/Dados_API/Tabela_nova.csv')

# Filtrando as linhas onde o valor na coluna 'CO.Fabrica' é igual a "3423909"
df_filtrado = df.loc[Tabela_nova['CO.Fabrica'] == 3423909]
...
for veiculo in veiculos:
    ...
    df_veiculo = Tabela_nova[Tabela_nova['Veiculo'] == veiculo]
...
quantidade_por_cidade = Tabela_nova.groupby('MUN')['Qtd.Transp'].sum()
...
contagem_veiculos = Tabela_nova['Veiculo'].value_counts()
...
quantidade_por_mes = Tabela_nova.groupby('Mes.Base')['Qtd.Transp'].sum()
...
Tabela_veiculos = Tabela_nova[Tabela_nova['Veiculo'].isin(['P12', 'P24'])]
